...
class MyConfig:
    def __init__(self):
        ...
        self.block_config=(1, 2, 4, 3) # DenseNet-25: (1, 2, 4, 3) / default (DenseNet-121): (6, 12, 24, 16)
        self.input_type="CIFAR-10"
...
class DenseNet(nn.Module):
    def __init__(self,
        ...
        elif input_type=="CIFAR-10":
            self.input_features.add_module("conv0", nn.Conv2d(input_channels, 16, kernel_size=1, bias=False))    
            in_channels = 16  
...
# model
model = DenseNet(config.growth_rate, config.block_config, input_type=config.input_type)
